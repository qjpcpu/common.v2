...
import (
	...
	"github.com/qjpcpu/common.v2/static/mockgen/internal/tests/custom_package_name/client/v1"

	//  matching import suffix and package name
	"github.com/qjpcpu/common.v2/static/mockgen/internal/tests/custom_package_name/validator"
)
